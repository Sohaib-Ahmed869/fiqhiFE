  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.type === "reservation") {
        ...
        toast.success("Marriage reservation submitted successfully!");
      } else {
      ...
      // Navigate to the marriage queries page after successful submission
      navigate("/user/marriage-queries");
    } catch (err) {
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Enter details for your new marriage application
            </p>
          </div>
          <button
...
export default NewMarriageScreen;
